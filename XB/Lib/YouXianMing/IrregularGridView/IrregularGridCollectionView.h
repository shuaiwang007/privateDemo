...
@property (nonatomic, assign) BOOL nibView;

@end

NS_INLINE IrregularGridViewCellClassType *gridViewCellClassType(Class className, NSString  *reuseIdentifier, BOOL nibView) {
